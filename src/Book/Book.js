  ...
  createContent() {
    ...
    let content = (
      <div className="details">
        ...
        {this.props.details && <RadarChart captions={captions} data={bookData} options={{scales: 5, zoomDistance: 1.32, captionMargin: 15, captionProps: ()=> ({fontSize: 16, textAnchor: 'middle', fontWeight: 'bold', fontFamily: 'sans-serif'})}}size={300}/>}
      </div>
    )
    return content
  }
